...
| `hidden_stems_v1` | `1.0.0` | `docs/22_HIDDEN_STEMS_SCOPE_AUDIT.md`: selected compact-only convention and two complete-table comparisons. | `tests/test_data_and_hidden_stems.py` locks every compact row and role order. | **Approved 2026-09-16** for compact hidden stems; seasonal model remains separate. |
