...
export const EMBEDDED_SOLAR_TERMS: SolarTermEntry[] = [
  // ── 1990년 ──────────────────────────────────────────
  { name: '입춘',  utcTime: new Date('1989-02-04T00:27:00Z').getTime(), solarLongitude: 315, isMajor: true,  monthJiIdx: 2  },
  { name: '소한',  utcTime: new Date('1990-01-05T19:01:00Z').getTime(), solarLongitude: 285, isMajor: true,  monthJiIdx: 1  },
  { name: '대한',  utcTime: new Date('1990-01-20T12:27:00Z').getTime(), solarLongitude: 300, isMajor: false },
  { name: '입춘',  utcTime: new Date('1990-02-04T06:14:00Z').getTime(), solarLongitude: 315, isMajor: true,  monthJiIdx: 2  },
  { name: '우수',  utcTime: new Date('1990-02-19T02:14:00Z').getTime(), solarLongitude: 330, isMajor: false },
  { name: '경칩',  utcTime: new Date('1990-03-06T00:19:00Z').getTime(), solarLongitude: 345, isMajor: true,  monthJiIdx: 3  },
  { name: '춘분',  utcTime: new Date('1990-03-21T01:19:00Z').getTime(), solarLongitude: 0,   isMajor: false },
  { name: '청명',  utcTime: new Date('1990-04-05T05:27:00Z').getTime(), solarLongitude: 15,  isMajor: true,  monthJiIdx: 4  },
  { name: '곡우',  utcTime: new Date('1990-04-20T12:26:00Z').getTime(), solarLongitude: 30,  isMajor: false },
  { name: '입하',  utcTime: new Date('1990-05-05T22:45:00Z').getTime(), solarLongitude: 45,  isMajor: true,  monthJiIdx: 5  },
  { name: '소만',  utcTime: new Date('1990-05-21T11:38:00Z').getTime(), solarLongitude: 60,  isMajor: false },
  { name: '망종',  utcTime: new Date('1990-06-06T02:33:00Z').getTime(), solarLongitude: 75,  isMajor: true,  monthJiIdx: 6  },
  { name: '하지',  utcTime: new Date('1990-06-21T19:33:00Z').getTime(), solarLongitude: 90,  isMajor: false },
  { name: '소서',  utcTime: new Date('1990-07-07T12:41:00Z').getTime(), solarLongitude: 105, isMajor: true,  monthJiIdx: 7  },
  { name: '대서',  utcTime: new Date('1990-07-23T06:21:00Z').getTime(), solarLongitude: 120, isMajor: false },
  { name: '입추',  utcTime: new Date('1990-08-07T22:31:00Z').getTime(), solarLongitude: 135, isMajor: true,  monthJiIdx: 8  },
  { name: '처서',  utcTime: new Date('1990-08-23T13:21:00Z').getTime(), solarLongitude: 150, isMajor: false },
  { name: '백로',  utcTime: new Date('1990-09-08T01:46:00Z').getTime(), solarLongitude: 165, isMajor: true,  monthJiIdx: 9  },
  { name: '추분',  utcTime: new Date('1990-09-23T11:22:00Z').getTime(), solarLongitude: 180, isMajor: false },
  { name: '한로',  utcTime: new Date('1990-10-08T17:31:00Z').getTime(), solarLongitude: 195, isMajor: true,  monthJiIdx: 10 },
  { name: '상강',  utcTime: new Date('1990-10-23T20:41:00Z').getTime(), solarLongitude: 210, isMajor: false },
  { name: '입동',  utcTime: new Date('1990-11-07T21:02:00Z').getTime(), solarLongitude: 225, isMajor: true,  monthJiIdx: 11 },
  { name: '소설',  utcTime: new Date('1990-11-22T18:47:00Z').getTime(), solarLongitude: 240, isMajor: false },
  { name: '대설',  utcTime: new Date('1990-12-07T14:32:00Z').getTime(), solarLongitude: 255, isMajor: true,  monthJiIdx: 0  },
  { name: '동지',  utcTime: new Date('1990-12-22T07:07:00Z').getTime(), solarLongitude: 270, isMajor: false },
  // ── 1990년 입춘 (연주 기준) ──────────────────────────
  { name: '입춘',  utcTime: new Date('1991-02-04T12:08:00Z').getTime(), solarLongitude: 315, isMajor: true,  monthJiIdx: 2  },
  // ── 2023년 입춘 ──────────────────────────────────────
  { name: '입춘',  utcTime: new Date('2023-02-04T02:43:00Z').getTime(), solarLongitude: 315, isMajor: true,  monthJiIdx: 2  },
  // ── 2024년 ──────────────────────────────────────────
