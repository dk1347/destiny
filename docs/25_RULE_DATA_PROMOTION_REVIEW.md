...
| --- | --- | --- | --- | --- |
| `core_tables_v1` | `1.0.0` | `docs/24_CORE_TABLES_SOURCE_AUDIT.md`: canonical orders, calculation element/polarity, five-element cycles, hour windows, and major-term/month mapping. | `tests/test_data_and_hidden_stems.py` locks cycles, 12 windows, 12 major-term mappings, and 22 calculation attributes. | **Pending** — field-level source/reuse record and reviewer sign-off. |
